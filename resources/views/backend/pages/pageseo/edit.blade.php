            ...
            <div class="card">
              <div class="card-body">
                    ...
                    @endif
                      ...
                      <div class="col-lg-12 d-flex images">
                        ...
                        <div class="item mx-4" data-id="{{$pageseo->id}}" data-model="Pageseo" data-image_no="{{$item['image_no']}}">
                            ...
                            <div class="mt-4">
                                <label class="d-block">
                                    <input class="radio_animated vitrinBtn" type="radio" {{$item['vitrin'] == 1 ? 'checked' : ''}}  >Build a showcase
                                </label>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lang" name="lang" value="{{$pageseo->lang ?? 'en'}}" placeholder="Lang">
                </div>
                  <div class="form-group">
                    <label for="name">Site URL</label>
                    <input type="text" class="form-control" id="page" name="page" value="{{$pageseo->page ?? ''}}" placeholder="Page  Title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description" name="description" value="{{$pageseo->description ?? ''}}" placeholder="Description">
                  </div>

                  <div class="form-group">
                    <label for="link">Keywords</label>
                    <input type="text" class="form-control" id="keywords" name="keywords" value="{{$pageseo->keywords ?? ''}}" placeholder="Keywoords">
                  </div>
                  <div class="form-group">
