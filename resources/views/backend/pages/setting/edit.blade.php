            ...
            <div class="card">
              <div class="card-body">
                ...
                @if (isset($setting->set_type) && $setting->set_type == 'image')
                    <div class="mb-2">
                        <img src="{{asset($setting->data ?? 'img/notimage.webp')}}" alt="">
                    </div>
                ...
                <form action="{{$routelink}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{$setting->name ?? ''}}" placeholder="Slider  title">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="inputContent">
                        ...
                        <input type="text" name="data" placeholder="" value="{{$setting->data ?? ''}}" class="form-control">
