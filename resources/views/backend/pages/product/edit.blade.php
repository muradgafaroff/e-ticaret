              ...
              <div class="card-body">
                ...
                <form action="{{$routelink}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                    ...
                    @endif
                      ...
                      <div class="col-lg-12 d-flex images">
                        ...
                        <div class="item mx-4" data-id="{{$product->id}}" data-model="Product" data-image_no="{{$item['image_no']}}">
                            ...
                            <div class="mt-4">
                                <label class="d-block">
                                    <input class="radio_animated vitrinBtn" type="radio" {{$item['vitrin'] == 1 ? 'checked' : ''}}  >Make a Showcase
                                </label>
                            </div>
                        </div>
                        @endforeach
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{$product->name ?? ''}}" placeholder="Title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="color" name="color" value="{{$product->color ?? ''}}" placeholder="color">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="short_text" name="short_text" value="{{$product->short_text ?? ''}}" placeholder="description">
                  </div>


                  <div class="form-group">
                    <label for="content">Content Article</label>
                    <textarea class="form-control" id="editor" name="content" rows="3" placeholder="">{{$product->content ?? ''}}</textarea>
                  </div>
