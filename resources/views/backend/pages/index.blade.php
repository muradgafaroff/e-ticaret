        ...
        <div class="row">
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-tale">
              <div class="card-body">
                <p class="mb-4">Order Monthly Number</p>
                <p class="fs-30 mb-2">{{$mountTotalCount}}</p>
                <p>This Month's Order Number</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-dark-blue">
              <div class="card-body">
                <p class="mb-4">Order Monthly Earnings</p>
                <p class="fs-30 mb-2">{{$mountTotalPrice}}</p>
                <p>This Month's Order Earnings Number</p>
              </div>
            </div>
          </div>
        </div>
   ...
   {{-- <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title mb-0">Most Ordered Products</p>
