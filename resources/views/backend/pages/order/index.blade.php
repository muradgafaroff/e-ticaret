                ...
                @if (!empty($orders) && $orders->count() > 0)
                    ...
                    <tr class="item" item-id="{{ $order->id }}">
                        ...
                        <td>
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" class="status" data-on="Aktive" value="1" data-off="Passive" data-onstyle="success" data-offstyle="danger" {{ $order->status == '1' ? 'checked' : '' }}  data-toggle="toggle">
                            </label>
                          </div>
                        </td>
                        <td>{{$order->orders_count}}</td>
                        <td class="d-flex">
                            <a href="{{route('panel.order.edit',$order->id)}}" class="btn btn-primary mr-2">Edit</a>
