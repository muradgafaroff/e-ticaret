              ...
              <div class="card-body">
                ...
                <form action="{{ route('panel.about.update') }}" class="forms-sample" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{$about->name ?? ''}}" placeholder="Slider Title">
                  </div>
                  <div class="form-group">
                    <label for="editor">About</label>
                    <textarea class="form-control" id="editor" name="content" placeholder="About" rows="3">{!! $about->content ?? '' !!}</textarea>
                  </div>
