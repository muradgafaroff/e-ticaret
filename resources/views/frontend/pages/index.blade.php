        ...
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            ...
            <div class="intro-text text-center text-md-left">
              ...
              <p>
                <a href="{{$slider->link ?? ''}}" class="btn btn-sm btn-primary">Products</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 site-section-heading text-center pt-4">
            <h2>Our Newly Added Products</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="{{$settings['offers_image'] ?? ''}}" alt="Image placeholder" class="img-fluid rounded"></a>
          </div>
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            <h4>{{$settings['offers_title'] ?? ''}}</h4>
            <p>{{$settings['offers_text'] ?? ''}}</p>
            <p><a href="{{route('discountedproduct')}}" class="btn btn-primary btn-sm">Discounted products</a></p>
          </div>
        </div>
      </div>
    </div>
