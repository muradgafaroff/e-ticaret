    ...
    <div class="container">
      ...
      <div class="row mb-5">
              ...
              <div class="d-flex">
                ...
                <div class="btn-group">
                  ...
                  <select class="form-control" id="orderList">
                    <option class="dropdown-item" value="">Select Sort</option>
                    <option class="dropdown-item" value="id-asc">Sort by A-Z</option>
                    <option class="dropdown-item" value="id-desc">Sort by Z-A</option>
                    <option class="dropdown-item" value="price-asc">Sort by Low Price</option>
                    <option class="dropdown-item" value="price-desc">Sort by High Price</option>
                  </select>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-3 order-1 mb-5 mb-md-0">
          ...
          <div class="border p-4 rounded mb-4">
            <div class="mb-4">
              <h3 class="mb-3 h6 text-uppercase text-black d-block">Sort by Price</h3>
