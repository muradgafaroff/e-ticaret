    ...
    <div class="block-4-text p-4">
       ...
       @endphp
        ...
        <form id="addForm" method="POST">
            ...
            <input type="hidden" name="coupon_code" value="{{request()->segment(1) == 'discountedproduct' ? 'products' : ''}}">
          <button type="submit" class="buy-now btn btn-sm btn-primary">Add Cart</button>
